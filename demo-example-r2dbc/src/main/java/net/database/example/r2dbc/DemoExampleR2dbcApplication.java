package net.database.example.r2dbc;

import io.r2dbc.spi.ConnectionFactory;
import lombok.extern.slf4j.Slf4j;
import net.database.example.r2dbc.models.Customer;
import net.database.example.r2dbc.repository.CustomerRepository;
...
@Slf4j
public class DemoExampleR2dbcApplication {

    public static void main(String[] args) {
        SpringApplication.run(DemoExampleR2dbcApplication.class, args);
    }
